...
public class SeriesImagesPosters {
    ...
    public SeriesImagesPosters() {
    }

    public SeriesImagesPosters(Double aspectRadio, String filePath, Integer height, String iso_639_1, Double voteAverage, Integer voteCount, Integer width) {
