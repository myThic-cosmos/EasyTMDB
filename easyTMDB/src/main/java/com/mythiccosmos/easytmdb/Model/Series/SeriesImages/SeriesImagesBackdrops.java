...
public class SeriesImagesBackdrops {
    ...
    public SeriesImagesBackdrops() {
    }

    public SeriesImagesBackdrops(Double aspectRadio, String filePath, Integer height, String iso_639_1, Double voteAverage, Integer voteCount, Integer width) {
